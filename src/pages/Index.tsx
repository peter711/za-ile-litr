...
const FuelCard = ({
  ...
  <div className="group relative overflow-hidden rounded-xl bg-card border border-border p-6 shadow-sm hover:shadow-lg transition-all duration-300">
          ...
          <>
            ...
            <div className="bg-card border border-border rounded-xl p-5 text-sm text-muted-foreground space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href={data.pdf_url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  PDF
                </a>
              </div>
            </div>
